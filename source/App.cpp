...
<<<<<<< .mine
void App::drawLine(Point2int32 point1, Point2int32 point2, Color3 c, shared_ptr<Image>& image) {
||||||| .r1487
...
void App::drawHLine(Point2int32 point1, Point2int32 point2, Color3 c, shared_ptr<Image>& image) {
    float x0;
    float x1;
...
void App::drawVLine(Point2int32 point1, Point2int32 point2, Color3 c, shared_ptr<Image>& image) {
    /*  float x0;
        float x1;
...
void App::drawFlatLine(Point2int32 point1, Point2int32 point2, Color3 c, shared_ptr<Image>& image) {
    float x0;
    float x1;
    float y0;
    float y1;
...
void App::drawSteepLine(Point2int32 point1, Point2int32 point2, Color3 c, shared_ptr<Image>& image) {
    float x0;
    float x1;
    float y0;
    float y1;
...
void App::drawThickLine(Point2int32 point1, Point2int32 point2, Color3 c, int added, shared_ptr<Image>& image) {
